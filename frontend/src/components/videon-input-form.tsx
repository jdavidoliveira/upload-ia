    ...
    return (
        <form onSubmit={handleUploadVideo} className="space-y-6">
            ...
            <div className="space-y-2">
                ...
                <Textarea disabled={status !== 'waiting'} id="transcription_prompt" className="h-20 leading-relaxed resize-none" placeholder="Inclua palavras-chave mencionadas no vídeo, separadas por vírgula (,)" ref={promptInputRef} />
            </div>
